...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-lg border-2 border-border bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-lg border-2 border-border bg-white shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
function Clients({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full items-center justify-center overflow-hidden rounded-lg  pt-24 pb-10",
        className
      )}
      ref={containerRef}
    >
      ...
      <div className="flex  justify-between size-full gap-10">
        ...
        <div className="flex flex-col relative -top-16">
          <Circle2 ref={div6Ref} className="size-14">
            <Icons.openai />
          </Circle2>
        </div>
...
const Icons = {
  notion: () => (
    <img src="https://pbs.twimg.com/media/GSHjbB1WAAA4BVI?format=jpg&name=large" />
  ),
  openai: () => (
    <img src="https://pbs.twimg.com/media/GSHjbB1WAAA4BVI?format=jpg&name=large" className="size-full rounded-lg"/>
  ),
  googleDrive: () => (
    <svg
      width="100"
